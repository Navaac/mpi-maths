...
On va définir dans ce qui suit la topologie relative à $A$, c'est à dire les ouverts relatifs de $A$, fermés relatifs de $A$ et voisinages relatifs d'un poinr vis-à-vis de $A$.
...
\begin{proof}
    ...
    ssi $\forall j {Caractérisation - LHP}\in \ninter{1}{p}, \, f_j(x) \limitnorme{N'_j}{x}{a} \ell_j$.
\end{proof}
