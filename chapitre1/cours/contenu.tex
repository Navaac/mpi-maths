...
\begin{definition}{Norme et espace vectoriel normé}{}
    ...
    $(E, N)$ est alors appelé espace vectoriel normé (evn).
\end{definition}
...
\begin{definition}{Épigraphe d'une fonction}{}
    ...
    \[ E_f = \{(x,y) \in \R^2, x \in I et y \geqslant f(x)\}\]     
\end{definition}
...
\begin{proof}
    ...
    Donc $|\langle u, v \rangle| \leqslant ||u||_2 \cdot ||v||_2$ qui est l'inégalité de Cauchy Schwarz. 
