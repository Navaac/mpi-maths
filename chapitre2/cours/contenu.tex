...
\begin{proof}~\\
    ...
    \vspace{0.2em} Si $\ell_1$ et $\ell_2$ conviennent : 
...
\begin{theorement}{Lien suites-séries}{}
...
\begin{definitionnt}{Convergence}{}
    Soit $(u_n)_{n \in \N} \in E^{\N}$. On dit que $(u_n)$ est convergente pour N ssi 
...
\begin{remarque}
    On dit que $E$ est complet (et même de Banach).
\end{remarque}
