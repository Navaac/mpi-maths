...
\begin{exercice}
\begin{enumerate}
    \item On considère $a, b\in\mathbb{R}^{*}$, $u_{0}\in\mathbb{R}$ et $(u_{n})$ définie par $\forall n\in\mathbb{N}$, $u_{n+1}=au_{n}+b$.
...
\begin{enumerate}
    \item On considère deux suites numériques $(u_{n})_{n\in\mathbb{N}}$ et $(v_{n})_{n\in\mathbb{N}}$ telles que $(v_{n})_{n\in\mathbb{N}}$ est non nulle à partir d'un certain rang et $u_{n}\sim v_{n}$.
    Démontrer que $u_{n}$ et $v_{n}$ sont de même signe à partir d'un certain rang.

    \item Déterminer le signe, au voisinage de l'infini, de $u_{n}=\sinh(\frac{1}{n})-\tan(\frac{1}{n})$.
\end{enumerate}
\end{exercice}
...
Et donc par récurrence $|u_{n}-a|\le\beta^{n}|u_{0}-a|$ qui converge vers 0.
